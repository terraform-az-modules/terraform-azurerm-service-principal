...
This directory contains an example usage of the **terraform-azurerm-service-principle**.It demonstrates how to use the module to deploy a service principal with password and subscription-level role assignments 
